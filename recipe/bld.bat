...
set "FFLAGS=-D_CRT_SECURE_NO_WARNINGS -D_MT -D_DLL --target=x86_64-pc-windows-msvc --Wno-error=unknown"
set "LDFLAGS=--target=x86_64-pc-windows-msvc -Xflang --dependent-lib=msvcrt -fuse-ld=lld"
